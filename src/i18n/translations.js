export const TRANSLATIONS = {
  en: {
    ...
    toastCacheClearedOnUpdate: 'Updated to v{version} — lookup cache cleared',
    toastSteamMatchSaved: 'Steam App ID set to {id}',
    toastSteamMatchCleared: 'Steam match reset to automatic',
    on: 'ON',
    off: 'OFF',
    loading: 'Loading…',
    ...
    toastExportDone: 'Exported {name}',
    toastExportCopied: 'Copied to clipboard',
    toastExportCopyFailed: 'Could not copy',
    toastExportFailed: 'Could not export',
  },
  ru: {
    ...
    toastCacheClearedOnUpdate: 'Обновлено до v{version} — кэш запросов очищен',
    toastSteamMatchSaved: 'Steam App ID: {id}',
    toastSteamMatchCleared: 'Сопоставление Steam сброшено на авто',
    on: 'ВКЛ',
    off: 'ВЫКЛ',
    loading: 'Загрузка…',
    ...
    toastExportDone: 'Экспортировано: {name}',
    toastExportCopied: 'Скопировано в буфер',
    toastExportCopyFailed: 'Не удалось скопировать',
    toastExportFailed: 'Не удалось экспортировать',
  },
  zh: {
    ...
    toastCacheClearedOnUpdate: '已更新至 v{version} — 查询缓存已清空',
    toastSteamMatchSaved: 'Steam App ID 已设为 {id}',
    toastSteamMatchCleared: '已恢复自动匹配 Steam',
    on: '开',
    off: '关',
    loading: '加载中…',
    ...
    toastExportDone: '已导出 {name}',
    toastExportCopied: '已复制到剪贴板',
    toastExportCopyFailed: '复制失败',
  ...
  es: {
    ...
    toastCacheClearedOnUpdate: 'Actualizado a v{version} — caché de consultas vaciada',
    toastSteamMatchSaved: 'Steam App ID: {id}',
    toastSteamMatchCleared: 'Coincidencia de Steam restablecida a automática',
    on: 'ON',
    off: 'OFF',
    loading: 'Cargando…',
    ...
    toastExportDone: 'Exportado: {name}',
    toastExportCopied: 'Copiado al portapapeles',
    toastExportCopyFailed: 'No se pudo copiar',
    toastExportFailed: 'No se pudo exportar',
  ...
  pt: {
    ...
    toastCacheClearedOnUpdate: 'Atualizado para v{version} — cache de consultas limpo',
    toastSteamMatchSaved: 'Steam App ID: {id}',
    toastSteamMatchCleared: 'Correspondência Steam restaurada para automática',
    on: 'ON',
    off: 'OFF',
    loading: 'Carregando…',
    ...
    toastExportDone: 'Exportado: {name}',
    toastExportCopied: 'Copiado para a área de transferência',
    toastExportCopyFailed: 'Não foi possível copiar',
    toastExportFailed: 'Não foi possível exportar',
  ...
  de: {
    ...
    toastCacheClearedOnUpdate: 'Aktualisiert auf v{version} — Abfrage-Cache geleert',
    toastSteamMatchSaved: 'Steam App ID: {id}',
    toastSteamMatchCleared: 'Steam-Zuordnung auf automatisch zurückgesetzt',
    on: 'AN',
    off: 'AUS',
    loading: 'Lädt…',
    ...
    toastExportDone: 'Exportiert: {name}',
    toastExportCopied: 'In die Zwischenablage kopiert',
    toastExportCopyFailed: 'Kopieren fehlgeschlagen',
  ...
  fr: {
    ...
    toastCacheClearedOnUpdate: 'Mis à jour vers v{version} — cache de requêtes vidé',
    toastSteamMatchSaved: 'Steam App ID : {id}',
    toastSteamMatchCleared: 'Correspondance Steam rétablie en automatique',
    on: 'ON',
    off: 'OFF',
    loading: 'Chargement…',
    ...
    toastExportDone: 'Exporté : {name}',
    toastExportCopied: 'Copié dans le presse-papiers',
    toastExportCopyFailed: 'Échec de la copie',
  ...
  ja: {
    ...
    toastCacheClearedOnUpdate: 'v{version} に更新 — 照会キャッシュを消去しました',
    toastSteamMatchSaved: 'Steam App ID を {id} に設定',
    toastSteamMatchCleared: 'Steam一致を自動に戻しました',
    on: 'ON',
    off: 'OFF',
    loading: '読み込み中…',
    ...
    toastExportDone: 'エクスポートしました: {name}',
    toastExportCopied: 'クリップボードにコピーしました',
    toastExportCopyFailed: 'コピーに失敗しました',
  ...
  ko: {
    ...
    toastSettingsSaved: '설정이 저장됨',
    toastCacheClearedOnUpdate: 'v{version}(으)로 업데이트됨 — 조회 캐시 비움',
    toastSteamMatchSaved: 'Steam App ID: {id}',
    toastSteamMatchCleared: 'Steam 매칭을 자동으로 되돌림',
    on: '켜짐',
    off: '꺼짐',
    loading: '로딩 중…',
    ...
    toastExportDone: '내보냄: {name}',
    toastExportCopied: '클립보드에 복사됨',
    toastExportCopyFailed: '복사 실패',
  ...
  pl: {
    ...
    toastCacheClearedOnUpdate: 'Zaktualizowano do v{version} — wyczyszczono cache zapytań',
    toastSteamMatchSaved: 'Steam App ID: {id}',
    toastSteamMatchCleared: 'Dopasowanie Steam przywrócone do automatycznego',
    on: 'WŁ',
    off: 'WYŁ',
    loading: 'Ładowanie…',
    ...
    toastExportDone: 'Wyeksportowano: {name}',
    toastExportCopied: 'Skopiowano do schowka',
    toastExportCopyFailed: 'Nie udało się skopiować',
    toastExportFailed: 'Nie udało się wyeksportować',
