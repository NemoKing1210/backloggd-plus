export const TRANSLATIONS = {
  en: {
    ...
    exportHint: 'Download a Notion-compatible CSV of this game page. More formats coming soon.',
    exportFormats: 'Export format',
    exportAdvanced: 'Additional settings',
    exportRatingFormat: 'Rating format',
    exportRatingText: 'Text',
    exportRatingTextHint: 'Terrible → Amazing (Amazing = 5★ only)',
    ...
    exportFormatMarkdownHint: 'Notion page dump — coming soon.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Structured record — coming soon.',
  ...
  ru: {
    ...
    exportHint: 'Скачать CSV в формате Notion для этой страницы. Другие форматы появятся позже.',
    ...
    exportRatingTextHint: 'Terrible → Amazing (Amazing только за 5★)',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Дамп страницы Notion — скоро.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Структурированная запись — скоро.',
  ...
  zh: {
    ...
    exportButton: '导出',
    exportTitle: '导出游戏',
    exportHint: '下载与 Notion 兼容的 CSV。更多格式即将推出。',
    exportFormats: '导出格式',
    exportAdvanced: '其他设置',
    exportRatingFormat: '评分格式',
    exportRatingText: '文本',
    exportRatingTextHint: 'Terrible → Amazing（Amazing 仅限 5★）',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Notion 页面导出 — 即将推出。',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: '结构化记录 — 即将推出。',
    exportDownload: '下载',
    exportCopy: '复制',
    exportSoon: '即将推出',
    exportNoRating: '无评分',
  ...
  es: {
    ...
    exportHint: 'Descarga un CSV compatible con Notion de esta página. Más formatos pronto.',
    ...
    exportRatingTextHint: 'Terrible → Amazing (Amazing solo con 5★)',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Volcado de página Notion — próximamente.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Registro estructurado — próximamente.',
  ...
  pt: {
    ...
    exportHint: 'Baixe um CSV compatível com Notion desta página. Mais formatos em breve.',
    exportFormats: 'Formato de exportação',
    exportAdvanced: 'Configurações adicionais',
    exportRatingFormat: 'Formato da nota',
    exportRatingText: 'Texto',
    exportRatingTextHint: 'Terrible → Amazing (Amazing só com 5★)',
    exportRatingNumeric: 'Numérico',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Dump de página Notion — em breve.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Registro estruturado — em breve.',
  ...
  de: {
    ...
    exportHint: 'Notion-kompatibles CSV dieser Seite herunterladen. Weitere Formate folgen.',
    exportFormats: 'Exportformat',
    exportAdvanced: 'Weitere Einstellungen',
    exportRatingFormat: 'Bewertungsformat',
    exportRatingText: 'Text',
    exportRatingTextHint: 'Terrible → Amazing (Amazing nur bei 5★)',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Notion-Seitenexport — demnächst.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Strukturierter Datensatz — demnächst.',
  ...
  fr: {
    ...
    exportHint: 'Télécharger un CSV compatible Notion de cette page. D’autres formats bientôt.',
    ...
    exportRatingTextHint: 'Terrible → Amazing (Amazing uniquement à 5★)',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Dump de page Notion — bientôt.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Enregistrement structuré — bientôt.',
  ...
  ja: {
    ...
    exportHint: 'このページを Notion 互換の CSV でダウンロード。他の形式は近日対応。',
    exportFormats: 'エクスポート形式',
    exportAdvanced: '詳細設定',
    exportRatingFormat: '評価の形式',
    exportRatingText: 'テキスト',
    exportRatingTextHint: 'Terrible → Amazing（Amazing は 5★ のみ）',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Notion ページ出力 — 近日公開。',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: '構造化データ — 近日公開。',
  ...
  ko: {
    ...
    exportButton: '내보내기',
    exportTitle: '게임 내보내기',
    exportHint: '이 페이지를 Notion 호환 CSV로 다운로드합니다. 다른 형식은 곧 추가됩니다.',
    exportFormats: '내보내기 형식',
    exportAdvanced: '추가 설정',
    exportRatingFormat: '평점 형식',
    exportRatingText: '텍스트',
    exportRatingTextHint: 'Terrible → Amazing (Amazing는 5★만)',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Notion 페이지 덤프 — 곧 제공.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: '구조화 기록 — 곧 제공.',
    exportDownload: '다운로드',
    exportCopy: '복사',
    exportSoon: '곧',
  ...
  pl: {
    ...
    exportHint: 'Pobierz CSV zgodny z Notion dla tej strony. Więcej formatów wkrótce.',
    exportFormats: 'Format eksportu',
    exportAdvanced: 'Dodatkowe ustawienia',
    exportRatingFormat: 'Format oceny',
    exportRatingText: 'Tekst',
    exportRatingTextHint: 'Terrible → Amazing (Amazing tylko przy 5★)',
    ...
    exportFormatMarkdown: 'Markdown',
    exportFormatMarkdownHint: 'Zrzut strony Notion — wkrótce.',
    exportFormatJson: 'JSON',
    exportFormatJsonHint: 'Rekord strukturalny — wkrótce.',
