...
export default {
  ...
  generalGroupBackup: 'バックアップ',
  generalGroupBackupHint:
    'Plus の設定を書き出し／復元します。検索キャッシュは含まれません。',
  settingsExport: 'エクスポート',
  settingsExportHint: '現在の設定を JSON ファイルでダウンロードします。',
  settingsImport: 'インポート',
  settingsImportHint: '以前エクスポートした JSON から設定を復元します。',
  settingsImportConfirmTitle: '設定をインポートしますか？',
  settingsImportConfirm:
    '現在の設定が置き換えられます。ページが再読み込みされます。検索キャッシュは変更されません。',
  settingsImportConfirmAction: 'インポート',
  toastSettingsExportedTitle: '設定をエクスポートしました',
  toastSettingsExported: 'バックアップファイルをダウンロードしました。',
  toastSettingsExportFailedTitle: 'エクスポート失敗',
  toastSettingsExportFailed: 'バックアップファイルを作成できませんでした。',
  toastSettingsImportedTitle: '設定をインポートしました',
  toastSettingsImported: '設定を復元しました。ページを再読み込みします。',
  toastSettingsImportFailedTitle: 'インポート失敗',
  toastSettingsImportInvalid: '有効な設定バックアップではありません。',
  toastSettingsImportEmpty: 'ファイルに設定が見つかりませんでした。',
  toastSettingsImportTooLarge: 'ファイルが大きすぎてインポートできません。',
  toastSettingsImportReadFailed: 'ファイルを読み取れませんでした。',
