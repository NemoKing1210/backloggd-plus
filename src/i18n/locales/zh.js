...
export default {
  ...
  generalGroupBackup: '备份',
  generalGroupBackupHint: '导出或恢复 Plus 偏好设置。查找缓存不包含在内。',
  settingsExport: '导出',
  settingsExportHint: '下载包含当前设置的 JSON 文件。',
  settingsImport: '导入',
  settingsImportHint: '从先前导出的 JSON 文件恢复设置。',
  settingsImportConfirmTitle: '导入设置？',
  settingsImportConfirm: '当前偏好将被替换。页面将刷新。查找缓存不会更改。',
  settingsImportConfirmAction: '导入',
  toastSettingsExportedTitle: '设置已导出',
  toastSettingsExported: '备份文件已下载。',
  toastSettingsExportFailedTitle: '导出失败',
  toastSettingsExportFailed: '无法创建备份文件。',
  toastSettingsImportedTitle: '设置已导入',
  toastSettingsImported: '偏好已恢复。页面将刷新。',
  toastSettingsImportFailedTitle: '导入失败',
  toastSettingsImportInvalid: '该文件不是有效的设置备份。',
  toastSettingsImportEmpty: '文件中未找到设置。',
  toastSettingsImportTooLarge: '文件过大，无法导入。',
  toastSettingsImportReadFailed: '无法读取该文件。',
