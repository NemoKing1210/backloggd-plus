...
export default {
  ...
  generalGroupBackup: 'Sauvegarde',
  generalGroupBackupHint:
    'Exportez ou restaurez vos préférences Plus. Le cache de recherche n’est pas inclus.',
  settingsExport: 'Exporter',
  settingsExportHint: 'Télécharger un fichier JSON avec vos réglages actuels.',
  settingsImport: 'Importer',
  settingsImportHint: 'Restaurer les réglages depuis un JSON exporté précédemment.',
  settingsImportConfirmTitle: 'Importer les réglages ?',
  settingsImportConfirm:
    'Vos préférences actuelles seront remplacées. La page sera rechargée. Le cache de recherche ne change pas.',
  settingsImportConfirmAction: 'Importer',
  toastSettingsExportedTitle: 'Réglages exportés',
  toastSettingsExported: 'Fichier de sauvegarde téléchargé.',
  toastSettingsExportFailedTitle: 'Échec de l’export',
  toastSettingsExportFailed: 'Impossible de créer le fichier de sauvegarde.',
  toastSettingsImportedTitle: 'Réglages importés',
  toastSettingsImported: 'Préférences restaurées. La page va se recharger.',
  toastSettingsImportFailedTitle: 'Échec de l’import',
  toastSettingsImportInvalid: 'Ce fichier n’est pas une sauvegarde de réglages valide.',
  toastSettingsImportEmpty: 'Aucun réglage trouvé dans ce fichier.',
  toastSettingsImportTooLarge: 'Le fichier est trop volumineux pour être importé.',
  toastSettingsImportReadFailed: 'Impossible de lire ce fichier.',
