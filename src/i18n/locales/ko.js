...
export default {
  ...
  generalGroupBackup: '백업',
  generalGroupBackupHint:
    'Plus 설정을 내보내거나 복원합니다. 조회 캐시는 포함되지 않습니다.',
  settingsExport: '내보내기',
  settingsExportHint: '현재 설정이 담긴 JSON 파일을 다운로드합니다.',
  settingsImport: '가져오기',
  settingsImportHint: '이전에 내보낸 JSON 파일에서 설정을 복원합니다.',
  settingsImportConfirmTitle: '설정을 가져올까요?',
  settingsImportConfirm:
    '현재 설정이 교체됩니다. 페이지가 새로고침됩니다. 조회 캐시는 변경되지 않습니다.',
  settingsImportConfirmAction: '가져오기',
  toastSettingsExportedTitle: '설정 내보내기 완료',
  toastSettingsExported: '백업 파일을 다운로드했습니다.',
  toastSettingsExportFailedTitle: '내보내기 실패',
  toastSettingsExportFailed: '백업 파일을 만들 수 없습니다.',
  toastSettingsImportedTitle: '설정 가져오기 완료',
  toastSettingsImported: '설정을 복원했습니다. 페이지가 새로고침됩니다.',
  toastSettingsImportFailedTitle: '가져오기 실패',
  toastSettingsImportInvalid: '유효한 설정 백업 파일이 아닙니다.',
  toastSettingsImportEmpty: '파일에서 설정을 찾지 못했습니다.',
  toastSettingsImportTooLarge: '파일이 너무 커서 가져올 수 없습니다.',
  toastSettingsImportReadFailed: '파일을 읽을 수 없습니다.',
