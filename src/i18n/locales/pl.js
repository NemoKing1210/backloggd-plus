...
export default {
  ...
  generalGroupBackup: 'Kopia zapasowa',
  generalGroupBackupHint:
    'Eksportuj lub przywróć ustawienia Plus. Pamięć podręczna zapytań nie jest dołączana.',
  settingsExport: 'Eksportuj',
  settingsExportHint: 'Pobierz plik JSON z bieżącymi ustawieniami.',
  settingsImport: 'Importuj',
  settingsImportHint: 'Przywróć ustawienia z wcześniej wyeksportowanego pliku JSON.',
  settingsImportConfirmTitle: 'Zaimportować ustawienia?',
  settingsImportConfirm:
    'Bieżące preferencje zostaną zastąpione. Strona się przeładuje. Pamięć podręczna zapytań się nie zmieni.',
  settingsImportConfirmAction: 'Importuj',
  toastSettingsExportedTitle: 'Ustawienia wyeksportowane',
  toastSettingsExported: 'Pobrano plik kopii zapasowej.',
  toastSettingsExportFailedTitle: 'Eksport nieudany',
  toastSettingsExportFailed: 'Nie udało się utworzyć pliku kopii zapasowej.',
  toastSettingsImportedTitle: 'Ustawienia zaimportowane',
  toastSettingsImported: 'Preferencje przywrócone. Strona zostanie przeładowana.',
  toastSettingsImportFailedTitle: 'Import nieudany',
  toastSettingsImportInvalid: 'Ten plik nie jest prawidłową kopią ustawień.',
  toastSettingsImportEmpty: 'W pliku nie znaleziono ustawień.',
  toastSettingsImportTooLarge: 'Plik jest zbyt duży, by go zaimportować.',
  toastSettingsImportReadFailed: 'Nie udało się odczytać pliku.',
