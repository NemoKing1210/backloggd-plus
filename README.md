...
[![Version](https://img.shields.io/badge/version-0.7.24-green?style=for-the-badge)](CHANGELOG.md)
...
> **Status:** early (`0.7.24`). Backloggd enrichment + list badges + Steam / SteamDB → Backloggd buttons.
...
- Cache duration + clear cache (expired prune + LRU soft limit; players / library keep short TTLs)
